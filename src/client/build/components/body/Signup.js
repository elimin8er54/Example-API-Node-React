...
function Login(props) {
    ...
    function handleSubmit(event) {
        fetch(`${config_json_1.default.SERVER_URL}api/signup`, {
            method: "post",
    ...
    return (react_1.default.createElement("div", { className: "signup" },
        react_1.default.createElement("h4", null, "Sign-Up"),
        react_1.default.createElement("form", { onSubmit: handleSubmit },
            ...
            react_1.default.createElement("button", { type: "button", className: "signup_button", onClick: props.swapper }, "Switch to Login"))));
}
